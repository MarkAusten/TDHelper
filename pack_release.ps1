...
$srcpath = "$PSScriptRoot\TradeDangerousGUI"
$srcpathb = "$PSScriptRoot\TradeDangerousGUI\bin\Release"
...
$outfileb = "$binpath\storage\TDHelper_v$callFileVersion.zip"
...
if (($binaries.count -gt 0) -and (Test-Path $binpath))
{
    ...
    cmd /c copy /y $PSScriptRoot\README.md $packpath
